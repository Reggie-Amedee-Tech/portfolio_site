    ...
    <main>
      <div className="mx-auto max-w-[1280px] page-x pt-8 pb-16">
        <div className="flex items-center gap-2 mb-6">
          ...
          <Small className="text-foreground/60">Open Channel</Small>
        </div>
      ...
      <footer className="border-t border-border">
        <div className="mx-auto max-w-[1280px] page-x py-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="flex flex-wrap items-center gap-x-4 gap-y-1">
            <Small className="text-foreground/60">R.J. Amedee</Small>
            <span className="text-foreground/20 hidden sm:inline">·</span>
            <Small className="text-foreground/60">Software Engineer</Small>
            <span className="text-foreground/20 hidden sm:inline">·</span>
            <Small className="text-foreground/60">New York</Small>
          </div>
          <div className="flex flex-wrap gap-2">
            {FOOTER_TECH_TAGS.map((t) => (
              <Badge
                key={t}
                variant="outline"
                className="h-auto rounded-[2px] px-2 py-0.5 font-mono text-[9px] uppercase tracking-widest text-foreground/60"
              >
                {t}
              </Badge>
            ))}
