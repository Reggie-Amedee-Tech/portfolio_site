  ...
  render: () => (
    <Card className="w-[360px] rounded ring-border">
      <CardHeader>
        ...
        <CardDescription>Three fields. Nothing gated behind it.</CardDescription>
      </CardHeader>
      <CardContent>
  ...
  render: () => (
    <Card className="w-[320px] rounded ring-border" size="sm">
      <CardContent className="px-4 py-3 flex items-start justify-between gap-4">
        ...
        <Button variant="link" size="sm" className="h-auto p-0 text-[10px] uppercase tracking-widest">
          Copy
        </Button>
      </CardContent>
    </Card>
